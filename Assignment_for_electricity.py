...
# Scenario: Electricity Management System for Residential Customers
...
def print_receipt(
    ...
    print("=========================================")
    print("Thank you for using the residential electricity system.")


def main():
    """Collect customer details, calculate usage, and print the bill."""
    print("========================================")
    print(" RESIDENTIAL ELECTRICITY MANAGEMENT SYSTEM")
    print("========================================")
